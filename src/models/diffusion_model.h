...
struct DiffusionModel : Model {
 ...
 private:
  ...
  // ashu: standard SD v1.5 uses native 768 dimensions
  // ashu: CLIP with 768 dimensions is the standard
  const int32_t hidden_size = 768; //1024;
  ...
  // ashu: for sd1-5, this is 7.5f
  const float guidance = 7.5f;  // 0.0f;
